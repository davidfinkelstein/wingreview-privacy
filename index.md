...
- **Account information:** You provide your email address, create a username, and can optionally upload a profile picture
- **User Content:** Reviews - ratings (0.0-10.0 scale), spiciness, photos, and any text you submit
- **Support requests:** If you contact support, we receive the information you include in your message. Email: wingreviewhelp@gmail.com
...
- Provide app features (accounts, posting reviews/photos, displaying content)
- Maintain safety and prevent abuse (moderation, fraud prevention)
- Improve performance and fix bugs
- Communicate with you (support, important account or policy updates)
...
If you delete your account, we delete or de-identify your personal data within a reasonable period, except where required for security/legal reasons. Backups may persist for a limited time.
